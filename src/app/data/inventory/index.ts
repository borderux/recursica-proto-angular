...
/** Good-case data: a fleet of GPUs and servers across datacenters. */
...
export const malformedInventory: unknown[] = [
  { id: 'inv-1', name: 'gpu-node-01', type: 'GPU' },
  { id: 42, name: 'srv-node-10', type: 'Server', utilization: '100%' },
  null,
];
